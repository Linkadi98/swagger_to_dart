...
abstract class AdvancedClient {
  ...
  @GET('/collection/set')
  Future<Result> advancedCollectionSet(
  ...
  @GET('/collection/dict')
  Future<Result> advancedCollectionDict();
  ...
  Future<Result> advancedCollectionTuple(@Query('items') List<dynamic> items);
  ...
  Future<Result> advancedCollectionVariableTuple(
  ...
  @GET('/union/modern')
  Future<Result> advancedUnionModern({@Query('value') required dynamic value});
  ...
  Future<Result> advancedCustomPositiveInt(
  ...
  @GET('/depends/query')
  Future<Result> advancedDependsQuery({
  ...
  @GET('/depends/class')
  Future<Result> advancedDependsClass(
  ...
  Future<Result> advancedErrorNotFound(@Path('item_id') int itemId);
  ...
  @GET('/errors/custom')
  Future<Result> advancedErrorCustom(@Query('code') int code);
}
